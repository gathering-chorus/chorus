...
**Last updated**: 2026-03-12 by Wren (PM) — #1290 freshness audit (message count, consumer list)
...
Query the Chorus index — 97K+ messages across Slack, Claude sessions, briefs, decisions, spine events, and stories.
