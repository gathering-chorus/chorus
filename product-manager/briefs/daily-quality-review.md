# Daily Quality Review — 2026-07-20
...
**RED** — BLOCKED: `ts-jest` preset not found (node_modules incomplete). Day 39.
- 0 tests run. No change from 2026-07-19.
- **Action:** `npm ci` needed to restore node_modules across all packages.

## Lint (`directing/clearing`)
**RED** — BLOCKED: `@eslint/js` not found in root node_modules. Day 41.
...
**RED** — 154 type errors. **No change from 2026-07-19** (was 154). Day 13 at this count.
...
**RED** — BLOCKED: `ts-jest` preset not found. Day 39.
...
## Failure Delta (vs 2026-07-19)
- **NO NEW REGRESSIONS:** Build type errors held at 154 (no change). Day 13 unchanged.
- **UNCHANGED:** All 4 suites blocked by `ts-jest preset not found` — now day 39.
- **UNCHANGED:** Lint blocked (`@eslint/js`) — now day 41.
- **Primary blocker remains:** `npm ci` at repo root unblocks all suites, lint, and build in one step. Now **41 days unresolved.**
