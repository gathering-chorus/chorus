# Daily Quality Review — 2026-07-17
...
**RED** — BLOCKED: `ts-jest` preset not found (node_modules incomplete). Day 36.
- 0 tests run. No change from 2026-07-16.
- **Action:** `npm ci` needed to restore node_modules across all packages.

## Lint (`directing/clearing`)
**RED** — BLOCKED: `@eslint/js` not found in root node_modules. Day 38.
...
**RED** — 154 type errors. **No change from 2026-07-16** (was 154). Day 10 at this count.
...
**RED** — BLOCKED: `ts-jest` preset not found. Day 36.
...
## Failure Delta (vs 2026-07-16)
- **NO NEW REGRESSIONS:** Build type errors held at 154 (no change). Day 10 unchanged.
- **UNCHANGED:** All 4 suites blocked by `ts-jest preset not found` — now day 36.
- **UNCHANGED:** Lint blocked (`@eslint/js`) — now day 38.
