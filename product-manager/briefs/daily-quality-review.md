# Daily Quality Review — 2026-07-18
...
**RED** — BLOCKED: `ts-jest` preset not found (node_modules incomplete). Day 37.
- 0 tests run. No change from 2026-07-17.
- **Action:** `npm ci` needed to restore node_modules across all packages.

## Lint (`directing/clearing`)
**RED** — BLOCKED: `@eslint/js` not found in root node_modules. Day 39.
...
**RED** — 154 type errors. **No change from 2026-07-17** (was 154). Day 11 at this count.
...
**RED** — BLOCKED: `ts-jest` preset not found. Day 37.
...
## Failure Delta (vs 2026-07-17)
- **NO NEW REGRESSIONS:** Build type errors held at 154 (no change). Day 11 unchanged.
- **UNCHANGED:** All 4 suites blocked by `ts-jest preset not found` — now day 37.
- **UNCHANGED:** Lint blocked (`@eslint/js`) — now day 39.
