#!/bin/bash
# athena-make generated-route conformance walker (#3354 AC4) — for a LIVE server,
...
# hardcoded platform/services/athena-make/generated/. Repointed as part of the
# repoTarget migration (old generated/ retired). Follow-on: derive this via
# `athena-make generate-target --class Domain` so the path stays config-as-data.
