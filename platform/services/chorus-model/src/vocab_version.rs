...
//!
//! Jeff, 2026-08-15/16: "are our owl and owl-api domains semantically
...
//! athena-make (owl-api) IMPLEMENTS them by projecting the version it serves.
//!
...
//! the MODEL_SET) so the store carries `chorus:vocabVersion` and owl-api can
...
pub fn record(root: &str, verb: &str, target: &str, by: &str, card: &str) -> Result<String, String> {
    ...
    // version and owl-api serves it. Rewritten whole each time (generated
