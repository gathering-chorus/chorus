...
fn sensitive_paths_uses_roles_silas() {
    let source = std::fs::read_to_string(
        "/Users/jeffbridwell/CascadeProjects/chorus/platform/services/chorus-hooks/src/hooks/sensitive_paths.rs"
...
fn health_command_uses_roles_silas() {
    let source = std::fs::read_to_string(
        "/Users/jeffbridwell/CascadeProjects/chorus/platform/services/chorus-hooks/src/commands/health.rs"
