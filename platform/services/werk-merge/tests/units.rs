...
// #3499 — REMOVED: round_check / demoed_patch_ids tests. Those helpers backed the
// demo-facts land gate, which werk-merge no longer has (orchestrator owns ordering).
