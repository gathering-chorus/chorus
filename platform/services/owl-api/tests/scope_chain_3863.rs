...
use owl_api::{build_scope_chain, effective_response, scope_kind_from_class, ScopeKind};
...
fn the_fetch_walks_ancestry_not_just_the_node() {
    let q = owl_api::effective_fetch_query("https://x#role-wren", "urn:chorus:instances");
