...
<!-- GENERATED by owl-api page_html (#3420). PROJECTION — regenerate from the model, never hand-edit. system.css = #3415 vocabulary; facet data from the existing Athena endpoints (same-origin); identity from owl-api. -->
...
<nav class="navbar no-print">
  ...
  <span class="muted">&rsaquo;</span> <span id="bc-domain">Domain</span>
</nav>
<div class="wrap">
  <h1 id="domain-title">{{CLASS}}</h1>
  <p class="muted" id="domain-subtitle"></p>
  <div class="content-actions" id="content-actions" data-title="Athena Domain" data-url="">
