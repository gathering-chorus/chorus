...
fn testresult_batch_reuses_auth_prepares_all_and_delegates_one_exact_ndjson_call() {
    ...
    // #4294 — the owner is a Principal edge, never a literal field.
    let line_a = r#"{"kind":"test-result","name":"tr-batch-a","fields":{"filePath":"platform/a.rs","result":"pass","testName":"keeps },{ and \"quoted\""},"more_values":[],"edges":[["ownedBy","principal","wren"],["ofTest","test","test-a"]],"graph":"urn:chorus:domains:tests"}"#;
    let line_b = r#"{"kind":"test-result","name":"tr-batch-b","fields":{"filePath":"platform/b.rs","result":"fail","testName":"second"},"more_values":[],"edges":[["ownedBy","principal","wren"],["ofTest","test","test-b"]],"graph":"urn:chorus:domains:tests"}"#;
