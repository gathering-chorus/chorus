...
describe('resolveBucket', () => {
  ...
  test("resolves won't do bucket and aliases", () => {
    expect(resolveBucket(GATHERING, "won't do")).toBe(31);
    expect(resolveBucket(GATHERING, 'wd')).toBe(31);
    expect(resolveBucket(GATHERING, 'dup')).toBe(31);
    expect(resolveBucket(GATHERING, 'killed')).toBe(31);
    expect(resolveBucket(GATHERING, 'wontdo')).toBe(31);
    expect(resolveBucket(GATHERING, 'not doing')).toBe(31);
  });
