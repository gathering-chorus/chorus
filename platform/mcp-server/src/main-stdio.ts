...
import { authenticateAgentRequest, apiIdentityVerifier, apiSessionVerifier, identityMode } from './request-identity';
...
async function main(): Promise<void> {
  ...
  const server = buildStdioServer(identity.role, { identity, authenticate });
