...
```bash
CHAT_ID=$(bash /Users/jeffbridwell/CascadeProjects/platform/scripts/chat.sh start <your-role> <other-role> "<topic>")
```
...
```bash
bash /Users/jeffbridwell/CascadeProjects/platform/scripts/chat.sh say $CHAT_ID <your-role> "your message here"
```

### Step 3: Nudge the other role to join

```bash
bash /Users/jeffbridwell/CascadeProjects/platform/scripts/nudge <other-role> "[chat] Join chat $CHAT_ID — topic: <topic>. Read: bash /Users/jeffbridwell/CascadeProjects/platform/scripts/chat.sh read $CHAT_ID | Reply: bash /Users/jeffbridwell/CascadeProjects/platform/scripts/chat.sh say $CHAT_ID <their-role> \"message\" | When done, both stop."
```
...
```bash
bash /Users/jeffbridwell/CascadeProjects/platform/scripts/chat.sh read $CHAT_ID --since <last_line>
```
...
1. ```bash
   bash /Users/jeffbridwell/CascadeProjects/platform/scripts/chat.sh end $CHAT_ID
   ```
...
1. Read the chat so far: `bash /Users/jeffbridwell/CascadeProjects/platform/scripts/chat.sh read $CHAT_ID`
2. Reply: `bash /Users/jeffbridwell/CascadeProjects/platform/scripts/chat.sh say $CHAT_ID <your-role> "response"`
...
- **Jeff can see the transcript** — `bash /Users/jeffbridwell/CascadeProjects/platform/scripts/chat.sh read $CHAT_ID`
