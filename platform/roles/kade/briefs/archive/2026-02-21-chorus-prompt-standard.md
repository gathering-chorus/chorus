...
Nothing — it's already wired into the shared startup scripts. Your next session start will use it automatically. If you want to refresh mid-session: `~/.chorus/scripts/chorus-prompt.sh kade`
