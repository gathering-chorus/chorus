# Doc coherence report — 2026-07-17 09:10
...
Same content at multiple paths (real forks — #2461 coherence resolves per-dup).

- hash `f9787ed1fee2` (2 copies):
  - docs/ACCESS_CONTROL_MATRIX.md
  - roles/wren/access-control-permutation-matrix.md
- hash `ee28561906cf` (2 copies):
  - docs/GUARDRAILS.md
...
- hash `b67767a58686` (2 copies):
  - roles/wren/chorus-scope-diagram.html
  - designing/docs/chorus-scope-diagram.html
- hash `8ba794f308d1` (2 copies):
  - roles/silas/chorus/communication-flows.md
  - designing/docs/communication-flows.md
- hash `6f2a87aa6f47` (2 copies):
...
- `UNIFIED_INDEX_ARCHITECTURE.md` (2 paths, 2 distinct hashes):
  - docs/UNIFIED_INDEX_ARCHITECTURE.md (b2386e0c76f4) 
...
- `SCALING_RDF_TRIPLES.md` (2 paths, 2 distinct hashes):
  - docs/SCALING_RDF_TRIPLES.md (0c18969acb87) 
  - data/about/SCALING_RDF_TRIPLES.md (ecbb7918aa28)
- `PUBLIC_ACCESS.md` (2 paths, 2 distinct hashes):
  - docs/PUBLIC_ACCESS.md (e3747413d98f) 
  - data/about/PUBLIC_ACCESS.md (a725db0d1c88)
- `PRODUCT_TEMPLATE.md` (2 paths, 2 distinct hashes):
  - directing/products/cards/PRODUCT_TEMPLATE.md (c4345ade26f5) 
  - platform/seeds/PRODUCT_TEMPLATE.md (99e113b2310d)
- `OWNER_PERSONA.md` (2 paths, 2 distinct hashes):
  - docs/OWNER_PERSONA.md (c0ead4b14ce0) 
  - data/about/OWNER_PERSONA.md (3a30129fae38)
- `ONTOLOGY_STATUS.md` (2 paths, 2 distinct hashes):
  - docs/ONTOLOGY_STATUS.md (4df48e052029) 
...
- `BUILD.md` (2 paths, 2 distinct hashes):
  - platform/services/chorus-hooks/BUILD.md (fb83407b0ee4) 
  - platform/services/chorus-inject/BUILD.md (baf3a408e1ca)
- `BOOK_CATALOG_WORKFLOW.md` (2 paths, 2 distinct hashes):
  - docs/BOOK_CATALOG_WORKFLOW.md (af1d5d1665b3) 
  - data/about/BOOK_CATALOG_WORKFLOW.md (5c41f48a7826)
- `ARCHITECTURE_DECISIONS.md` (2 paths, 2 distinct hashes):
  - docs/ARCHITECTURE_DECISIONS.md (9005e4bec7b6) 
  - data/about/ARCHITECTURE_DECISIONS.md (bf5dcc19f8f7)
