...
**Date**: 2026-02-19
**Status**: Proposed — awaiting Kade's current work to land
...
#### 4. Docker Compose — Slack Bridge
**File**: `messages/slack-bridge/docker-compose.yml`
```yaml
ports:
  - "127.0.0.1:3460:3460"    # Was: "3460:3460"
```
...
| Slack Bridge | 3460 | 0.0.0.0 | 127.0.0.1 | slack-bridge/docker-compose.yml |
