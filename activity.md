...
- [silas 2026-05-04 09:18] → #2716 6/7 ACs (decisions GET route + MCP list + MCP get-matcher + Zod write path + ADR-028 graph reconcile); gate:arch-pass on Wren's #2664 → wren/jeff. Last AC awaits MCP reload.
